...
<code>by @blaar × @club5926</code>`,
    ...
    usageHint: (botUsername) => `<tg-emoji emoji-id="5884097155341226387">👁</tg-emoji> @${safeBotUsername(botUsername)} @friend hello — secret for @friend\n<tg-emoji emoji-id="6032609071373226027">👥</tg-emoji> @${safeBotUsername(botUsername)} hello @friend — hidden from @friend`,
    tooLongTitle: 'Too long: max 200 characters',
    tooLongHint: 'Secret is too long. Max 200 characters.',
    invalidTargetTitle: 'I did not get the recipient',
    invalidTargetHint: (botUsername) => `Recipient can be @username, 123456789, id:123456789 or @me.\n\nExample: @${safeBotUsername(botUsername)} @friend hello`,
    unverifiedTargetNote: 'not seen yet, matched by username',
...
<code>by @blaar × @club5926</code>`,
    ...
    usageHint: (botUsername) => `<tg-emoji emoji-id="5884097155341226387">👁</tg-emoji> @${safeBotUsername(botUsername)} @friend привет — секрет для @friend\n<tg-emoji emoji-id="6032609071373226027">👥</tg-emoji> @${safeBotUsername(botUsername)} привет @friend — секрет от @friend`,
    tooLongTitle: 'Слишком длинный: макс. 200 символов',
    tooLongHint: 'Секрет слишком длинный. Максимум 200 символов.',
    invalidTargetTitle: 'Не понял получателя',
    invalidTargetHint: (botUsername) => `Получатель — это @username, 123456789, id:123456789 или @me.\n\nПример: @${safeBotUsername(botUsername)} @friend привет`,
    unverifiedTargetNote: 'ещё не встречал, определю по юзернейму',
...
<code>by @blaar × @club5926</code>`,
    ...
    usageHint: (botUsername) => `<tg-emoji emoji-id="5884097155341226387">👁</tg-emoji> @${safeBotUsername(botUsername)} @friend привіт — секрет для @friend\n<tg-emoji emoji-id="6032609071373226027">👥</tg-emoji> @${safeBotUsername(botUsername)} привіт @friend — секрет від @friend`,
    tooLongTitle: 'Занадто довгий: макс. 200 символів',
    tooLongHint: 'Секрет занадто довгий. Максимум 200 символів.',
    invalidTargetTitle: 'Не зрозумів отримувача',
    invalidTargetHint: (botUsername) => `Отримувач — це @username, 123456789, id:123456789 або @me.\n\nПриклад: @${safeBotUsername(botUsername)} @friend привіт`,
    unverifiedTargetNote: 'ще не зустрічав, визначу за юзернеймом',
